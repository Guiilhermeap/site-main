      ...
      <ul class="flex flex-col pl-0 mb-0">
        <li class="mt-0.5 w-full">
          <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Publicações</span>
          </a>
        </li>
        ...
        <li class="mt-0.5 w-full">
          <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors"
            ...
            <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Currículos</span>
          </a>
        </li>
        ...
        <nav>
          ...
          <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
            ...
            <li
              ...
              aria-current="page">Currículos</li>
          </ol>
          <h6 class="mb-0 font-bold capitalize">Currículos</h6>
        </nav>
                ...
                <table class="items-center w-full mb-0 align-top border-gray-200 text-slate-500">
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        <p class="mb-0 font-semibold leading-tight text-xs">Front-end</p>
                      </td>

                      <td
                        class="p-2 text-center align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        <span class="font-semibold leading-tight text-xs text-slate-400">23/04/22</span>
                      </td>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        <a download="" href="assets/PDFs/Currículo Amanda.pdf" class="font-semibold leading-tight text-xs text-slate-400"> Baixar </a>
                      </td>
                    </tr>
                    <tr>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                      ...
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        <a download="" href="assets/PDFs/CV_GUILHERME.pdf" class="font-semibold leading-tight text-xs text-slate-400"> Baixar </a>
                      </td>
                    </tr>
                    <tr>
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                      ...
                      <td class="p-2 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                        <a download="" href="assets/PDFs/Curriculo Icaro.pdf" class="font-semibold leading-tight text-xs text-slate-400"> Baixar </a>
                      </td>
                    </tr>
                  </tbody>
                </table>
