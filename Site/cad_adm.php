...
if (isset($_POST['submit'])) {
  ...
  $result = mysqli_query($conexao, "INSERT INTO aluno (CPF,senha,nome,email,telefone,endereco,cargo)
  ...
  <div id="main-container">
    ...
    <form id="register-form" action="cad_adm.php" method="POST">
      ...
      <div class="full-box">
        ...
        <input type="text" name="cargo" id="cargo" placeholder="Digite seu Cargo" data-min-length="11" data-max-length="11" data-required>
      </div>
      ...
      <div>
        <a href="login_adm.html">Já está cadastrado?
        </a></label>
      </div>
