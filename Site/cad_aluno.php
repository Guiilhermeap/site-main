  ...
  <div id="main-container">
    ...
    <form id="register-form" action="cad_aluno.php" method="POST">
      ...
      <div>
        ...
        <input type="radio" id="gti" name="curso" value="GTI" required>
        <br>
        <label class="ls-label col-md 2" for="curso">Gestão Comercial</label>
        <input type="radio" id="gcom" name="curso" value="GCOM" required>
        <br>
        <label class="ls-label col-md 2" for="curso">Secretariado</label>
        <input type="radio" id="sc" name="curso" value="SC" required>
        <br>
        <label class="ls-label col-md 2" for="curso">Gestão Empresarial - EAD</label>
        <input type="radio" id="gemp" name="curso" value="GEMP" required>
        <br>
      </div>
      ...
      <div>
        ...
        <input type="radio" id="ead" name="periodo" value="EAD" required>
        <br>
      </div>
