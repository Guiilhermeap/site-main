...
if (isset($_POST['submit'])) {
    ...
    $txtPubli = $_POST['textPubli'];
    $publicacao = $_POST['tipoPubli'];
    $dataPublicacao = $_POST['dataPubli'];
...
<body class="m-0 font-sans antialiased font-normal text-base leading-default bg-gray-50 text-slate-500">
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-slate-700 before:float-left before:pr-2 before:text-gray-600 before:content-['/']" aria-current="page">TimeLine</li>
                    </ol>
                    <h6 class="mb-0 font-bold capitalize">TimeLine</h6>
                </nav>
        ...
        <div class="w-full px-6 py-6 mx-auto">
            ...
            <form id="register-form" action="timeline.php" method="POST">
                <div class="flex flex-wrap -mx-3">
                    <div class="flex-none w-full max-w-full px-3">
                        <div class="relative flex flex-col min-w-0 mb-6 break-words bg-white border-0 border-transparent border-solid shadow-soft-xl rounded-2xl bg-clip-border">
                            ...
                            <div>
                                <input type="radio" name="tipoPubli" value="curso" required /> Curso<br />
                                <input type="radio" name="tipoPubli" value="vaga" required /> Vaga<br />
                                <input type="radio" name="tipoPubli" value="evento" required /> Evento
                            </div>
                            <div class="full-box">
                                <label for="dataPubli">Data da Publicação</label>
                                <input class="site" type="date" name="dataPubli" id="dataPubli" required>
                            </div>
